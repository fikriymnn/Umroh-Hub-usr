          ...
          <div className=" w-10/12 h-full flex space-x-4">
            ...
            <div className=" flex w-full space-x-4 mt-3 rounded-[5px]">
              ...
              <div className="mt-[18px]">
                ...
                <input type="text" placeholder="Ketik Nama Pemilik Rekening..." className='placeholder:text-[15px] placeholder:text-[#95959599] placeholder:font-semibold
            ...
            <div className=" flex w-full space-x-8 mt-3 rounded-[5px]">
              ...
              <button className="rounded-full text-[24px] font-semibold text-white w-full mt-2 p-6 bg-gradient-to-br from-[#3C9BFF] to-[#10F5EA]">Bayar</button>
            </div>
          </div>
